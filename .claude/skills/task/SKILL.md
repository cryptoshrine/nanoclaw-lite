---
name: task
description: Manage a pending task list. Add, update, complete, or list tasks.
...
Manage a pending task list stored at `tasks/pending-tasks.md`.
...
### `/task remove [number]`
1. Read and remove the task section

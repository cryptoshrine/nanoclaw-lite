...
export default function DashboardPage() {
  ...
  const pausedTasks = stats.tasks.paused ?? 0;
  const failedTasks = stats.tasks.failed ?? 0;
  const totalTasks = activeTasks + completedTasks + pausedTasks + failedTasks;

  const activeTeams = stats.teams.active ?? 0;
  const completedTeams = stats.teams.completed ?? 0;
